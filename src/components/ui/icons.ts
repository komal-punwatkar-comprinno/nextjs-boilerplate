 ...
 *
 * Each entry maps a camelCase name to one or more SVG path `d` strings.
 * All icons are 24×24 Heroicons (outline) using `stroke="currentColor"`.
 *
 * To add a new icon:
 *   1. Add a key here with its path string(s).
 *   2. It becomes immediately available via <Icon name="yourKey" />.
 *
 * @example
...
export const iconPaths = {
  ...
  chat:         "M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-3 3v-3z",
  ...
  "chat-bubble-left":"M2.25 12.76c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.076-4.076a1.526 1.526 0 011.037-.443 48.282 48.282 0 005.68-.494c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z",
...
/** All valid icon names derived directly from the registry. */
