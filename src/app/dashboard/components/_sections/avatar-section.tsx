          ...
          <div className="flex items-center gap-3 flex-wrap">
            {["Alice Brown", "Bob K", "Carol Lee", "Dave M", "Eve Thompson"].map((name) => (
              <div key={name} className="flex flex-col items-center gap-1.5">
                ...
                <span className="text-xs text-slate-500">{name.split(" ")[0]}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              ...
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold text-slate-600 ring-2 ring-white">
                +4
              </span>
            </div>
            <span className="text-sm text-slate-500">9 team members</span>
          </div>
        </div>
      </div>
    </SectionWrapper>
