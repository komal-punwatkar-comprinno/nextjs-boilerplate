  ...
  return (
    <SectionWrapper id="spinners" title="8. Spinner / Loading">
      <div className="space-y-8">
        {/* Three sizes */}
        <div>
          <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-slate-400">Sizes</p>
        ...
        <div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-4 max-w-sm">
            {/* Header row */}
